...
import { Open, resolveAvailableEditors, resolveAvailableTerminalEmulators } from "./open";
...
> {
  ...
  const availableTerminalEmulators = resolveAvailableTerminalEmulators();
  ...
  const { openInEditor, openInTerminal } = yield* Open;
